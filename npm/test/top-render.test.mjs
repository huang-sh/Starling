...
test("renders top rows in running, waiting, idle, stopped order", () => {
  ...
  assert.match(output, /Starling top 4 pinned .* 2 active/);
  ...
  assert.ok(output.indexOf("approve git remote") < output.indexOf("idle task"));
